				...
				<div class="row">
					...
					<ul id="thumbs" class="portfolio">
						...
						<li class="item-thumbs span3 design" data-id="id-0"
							...
							title="The City" href="${pageContext.request.contextPath}/resources/img/works/full/image-01-full.jpg"> <span
						...
						<li class="item-thumbs span3 design" data-id="id-1"
							...
							<!-- Fancybox - Gallery Enabled - Title - Full Image --> <a
							class="hover-wrap fancybox" data-fancybox-group="gallery"
							title="The Office" href="${pageContext.request.contextPath}/resources/img/works/full/image-02-full.jpg"> <span
								class="overlay-img"></span> <span
								class="overlay-img-thumb font-icon-plus"></span>
						</a> <!-- Thumb Image and Description --> <img
						...
						<li class="item-thumbs span3 photography" data-id="id-2"
							...
							<!-- Fancybox - Gallery Enabled - Title - Full Image --> <a
							class="hover-wrap fancybox" data-fancybox-group="gallery"
							title="The Mountains" href="${pageContext.request.contextPath}/resources/img/works/full/image-03-full.jpg">
						...
						<li class="item-thumbs span3 photography" data-id="id-2"
							...
							<!-- Fancybox - Gallery Enabled - Title - Full Image --> <a
							class="hover-wrap fancybox" data-fancybox-group="gallery"
							title="The Mountains" href="${pageContext.request.contextPath}/resources/img/works/full/image-04-full.jpg">
								<span class="overlay-img"></span> <span
								class="overlay-img-thumb font-icon-plus"></span>
						</a> <!-- Thumb Image and Description --> <img
						...
						<li class="item-thumbs span3 photography" data-id="id-4"
							...
							<!-- Fancybox - Gallery Enabled - Title - Full Image --> <a
							class="hover-wrap fancybox" data-fancybox-group="gallery"
							title="The Sea" href="${pageContext.request.contextPath}/resources/img/works/full/image-05-full.jpg"> <span
								class="overlay-img"></span> <span
								class="overlay-img-thumb font-icon-plus"></span>
						</a> <!-- Thumb Image and Description --> <img
						...
						<li class="item-thumbs span3 photography" data-id="id-5"
							...
							<!-- Fancybox - Gallery Enabled - Title - Full Image --> <a
							class="hover-wrap fancybox" data-fancybox-group="gallery"
							title="Clouds" href="${pageContext.request.contextPath}/resources/img/works/full/image-06-full.jpg"> <span
								class="overlay-img"></span> <span
								class="overlay-img-thumb font-icon-plus"></span>
						</a> <!-- Thumb Image and Description --> <img
						...
						<li class="item-thumbs span3 photography" data-id="id-2"
							...
							<!-- Fancybox - Gallery Enabled - Title - Full Image --> <a
							class="hover-wrap fancybox" data-fancybox-group="gallery"
							title="The Mountains" href="${pageContext.request.contextPath}/resources/img/works/full/image-07-full.jpg">
								<span class="overlay-img"></span> <span
								class="overlay-img-thumb font-icon-plus"></span>
						</a> <!-- Thumb Image and Description --> <img
						...
						<li class="item-thumbs span3 design" data-id="id-0"
							...
							<!-- Fancybox - Gallery Enabled - Title - Full Image --> <a
							class="hover-wrap fancybox" data-fancybox-group="gallery"
							title="The Dark" href="${pageContext.request.contextPath}/resources/img/works/full/image-08-full.jpg"> <span
								class="overlay-img"></span> <span
								class="overlay-img-thumb font-icon-plus"></span>
						</a> <!-- Thumb Image and Description --> <img
