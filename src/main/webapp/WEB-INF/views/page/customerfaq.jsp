		...
		<div class="row">
			<div class="span8">
				...
				<table class="table table-striped">
					<thead>
						<tr>
							<th colspan="4"><a href="detail?id=${board.id }"> Q. 티켓은 어떻게 사용하죠?</a></th>
						</tr>
						<tr>
							<th colspan="4"><a href="detail?id=${board.id }"> Q. 환불 및 취소는 어떻게 하나요?</a></th>
						</tr>
						<tr>
							<th colspan="4"><a href="detail?id=${board.id }"> Q. 구매 후 영수증은 어떻게 발급받나요?</a></th>
						</tr>
						<tr>
							<th>글 번호</th>
							<th colspan="3">제목</th>
